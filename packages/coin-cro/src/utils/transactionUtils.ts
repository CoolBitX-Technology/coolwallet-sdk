...
export const genCROSigFromSESig = async (
...
export const getTxProtobuf = (
    ...
    const feeBuf = messages.Fee.encode({ amount: [{ denom: 'basecro', amount: signData.feeAmount.toString() }], gas_limit: signData.gas.toString() });
