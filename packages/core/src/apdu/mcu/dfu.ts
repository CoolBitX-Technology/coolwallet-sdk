...
export const resetFW = async (transport: Transport) => executeCommand(transport, commands.FW_RESET, target.MCU);

export const updateFW = async (transport: Transport, P1: string, P2: string, data: string) => executeCommand(transport, commands.FW_UPDATE, target.MCU, data, P1, P2);
