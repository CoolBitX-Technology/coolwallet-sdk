...
export const sendFWsign = async (transport, data) => executeCommand(transport, 'SEND_FW_SIGN', 'MCU', data);

export const FWreset = async (transport) => executeCommand(transport, 'FW_RESET', 'MCU');

export const FWupdate = async (transport, P1, P2, data) => executeCommand(transport, 'FW_UPDATE', 'MCU', data, P1, P2);
