...
describe('Test hash.ts', () => {
  it('Test getTransferArgument', async () => {
    ...
    const transferArgumentBuf = await getTransferArgumentBuffer(testTransaction, testAddressIndex);
    expect(transferArgumentBuf.toString('hex')).toMatchInlineSnapshot(
      `""`
    );
  });
  ...
  it('Test getUtxoArgument', async () => {
    ...
    const utxoArgumentBuf = await getUtxoArgumentBuffer(input, utxo, testAddressIndex);
