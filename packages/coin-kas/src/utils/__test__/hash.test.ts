...
describe('Test hash.ts', () => {
  it('Test getTransferArgument', async () => {
    ...
    expect(transferArgumentBuf.toString('hex')).toMatchInlineSnapshot(
      `""`
    );
  });
  ...
  it('Test getUtxoArgument', async () => {
    ...
    expect(utxoArgument).toMatchInlineSnapshot(
      `"348000002c8001b20780000000000000000000000021aa1aff85fc054381f8536d1ab8dbe68f1673a7c67b7ad7816431603c58d32e010000000000220000000000000020b1b89146cea93cf8bec6fa3d4d79c26586ac09a1e8ebf37aa5904629f63c857daccef3668c00000000000000000000000001"`
    );
  });
