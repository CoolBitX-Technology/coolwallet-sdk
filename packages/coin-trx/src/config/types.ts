...
export interface CancelAllUnfreezeDataV2 extends SignTxData {
  transaction: CancelAllUnfreezeContractV2;
}

export interface CancelAllUnfreezeContractV2 extends Transaction {
  contract: {
    ownerAddress: string;
  };
}
